            ...
            <div className="col-12 col-md-6 col-lg-4">
              <div className="card border-dark">
                <div className="card-body text-center p-4 p-xxl-5">
                  ...
                  <h4 className="mb-4">Wheel Truing</h4>
            ...
            <div className="col-12 col-md-6 col-lg-4">
              <div className="card border-dark">
                <div className="card-body text-center p-4 p-xxl-5">
                  ...
                  <h4 className="mb-4">Brake Adjustment</h4>
            ...
            <div className="col-12 col-md-6 col-lg-4">
              <div className="card border-dark">
                <div className="card-body text-center p-4 p-xxl-5">
                  ...
                  <h4 className="mb-4">Cassette Replacement</h4>
            ...
            <div className="col-12 col-md-6 col-lg-4">
              <div className="card border-dark">
                <div className="card-body text-center p-4 p-xxl-5">
                  ...
                  <h4 className="mb-4">Suspension Tuning</h4>
            ...
            <div className="col-12 col-md-6 col-lg-4">
              <div className="card border-dark">
                <div className="card-body text-center p-4 p-xxl-5">
                  ...
                  <h4 className="mb-4">Frame Alignment</h4>
            ...
            <div className="col-12 col-md-6 col-lg-4">
              <div className="card border-dark">
                <div className="card-body text-center p-4 p-xxl-5">
                  ...
                  <h4 className="mb-4">Pedal Installation</h4>
